...
(function() {
  ...
  Otalvaro.Views.pagination = (function(_super) {
    ...
    pagination.prototype.setCurrentPageNum = function(currentPageNum) {
      ...
      return this.render(renderedView);
    };
  ...
  Otalvaro.Views.naviItem = (function(_super) {
  ...
  Otalvaro.Views.pageBtn = (function(_super) {
    ...
    pageBtn.prototype.changePage = function(e) {
      ...
      this.navi.updatePage(this.crntPage);
      this.updateRoute();
      return null;
    };

    pageBtn.prototype.updateRoute = function() {
      var route;
      route = 'noticias/pagina/' + this.crntPage;
  ...
  })(Otalvaro.Views.naviItem);

  Otalvaro.Views.ReturnToListBtn = (function(_super) {
